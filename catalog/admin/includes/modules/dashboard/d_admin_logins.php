  ...
  class d_admin_logins {
    ...
    function getOutput() {
      $output = '<table class="table table-bordered table-hover" style="width: 100%; padding: 4px;">' .
                ...
                '    <th class="dataTableHeadingContent" style="text-align: right;">' . MODULE_ADMIN_DASHBOARD_ADMIN_LOGINS_DATE . '</th>' .
                '  </tr>' .
                '  </thead>';
      ...
      while ($logins = tep_db_fetch_array($logins_query)) {
        $output .= '  <tr class="dataTableRow" onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                   '    <td class="dataTableContent" style="text-align: center;">' . tep_image(DIR_WS_IMAGES . 'icons/' . (($logins['success'] == '1') ? 'tick.gif' : 'cross.gif')) . '</td>' .
                   ...
                   '    <td class="dataTableContent" style="text-align: right;">' . tep_date_short($logins['date_added']) . '</td>' .
                   '  </tr>';
      }

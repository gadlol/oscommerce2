  ...
  class d_customers {
    ...
    function getOutput() {
      $output = '<table class="table table-bordered table-hover" style="width: 100%; padding: 4px;">' .
                ...
                '    <th class="dataTableHeadingContent" style="text-align: right;">' . MODULE_ADMIN_DASHBOARD_CUSTOMERS_DATE . '</th>' .
                '  </tr>' .
                '  </thead>';
      ...
      while ($customers = tep_db_fetch_array($customers_query)) {
        $output .= '  <tr class="dataTableRow" onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                   ...
                   '    <td class="dataTableContent" style="text-align: right;">' . tep_date_short($customers['customers_info_date_account_created']) . '</td>' .
                   '  </tr>';
      }
